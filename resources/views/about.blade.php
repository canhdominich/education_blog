...
<div class="post-content-body" style="text-align: justify; color: black; margin-top: 20px;">
  <h2 class="mb-4">Xin chào mọi người, mình là Ánh</h2>
  <p class="mb-5"><img src="{{asset('blog/images/admin-anhhoang-hna.jpg')}}" alt="Image placeholder" class="img-fluid"></p>
  ...
  <p>Culpa porro quod doloribus dolore sint. Distinctio facilis ullam voluptas nemo voluptatum saepe repudiandae adipisci officiis, explicabo eaque itaque sed necessitatibus, fuga, ea eius et aliquam dignissimos repellendus impedit pariatur voluptates. Dicta perferendis assumenda, nihil placeat, illum quibusdam. Vel, incidunt?</p>
   <p class="mb-5"><img src="{{asset('blog/images/admin-hoanganh-hna.jpg')}}" alt="Image placeholder" class="img-fluid"></p>
