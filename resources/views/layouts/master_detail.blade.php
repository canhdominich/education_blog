			...
			<div class="container">
				<div class="collapse navbar-collapse" id="navbarMenu" style="margin-top: 10px;">
					<ul class="navbar-nav mx-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="category.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Đề cương môn học</a>
							<div class="dropdown-menu" aria-labelledby="dropdown04">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="category.html" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Chữa đề thi</a>
						...
						<div class="sidebar-box">
							<div class="bio text-center">
								...
								<div class="bio-body">
									...
									<h3>PTIT</h3>
									<p></p>
									<p><a href="#" class="btn btn-primary btn-sm">Facebook</a></p>
									<p class="social">
								...
								<ul>
									...
									<li>
										<a href="/{{$value->slug}}" title="{{$value->title}}">
											<img src="{{url('storage/uploads/'.$value->thumbnail)}}" alt="Image placeholder" class="mr-4">
											<div class="text">
												<h4>{{$value->title}}</h4>
												<div class="post-meta">
