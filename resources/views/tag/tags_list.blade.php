	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<!-- /.box-header -->
				<div class="box-body">
					<a href="/admin/new/tag" data-toggle="modal" class="btn btn-success btn-add">New Tag</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Tag Information : </h4>
					</div>
					<form action="" id="">
						@csrf
	...
	<div class="col-xs-12">
		<div class="modal fade" id="editTag" tabindex="-1" role="dialog" aria-labelledby="formTag" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Update Tag Information : </h4>
					</div>
